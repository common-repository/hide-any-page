...
if (!class_exists('HAP_HIDE_ANY_PAGE')) {
    ...
    class HAP_HIDE_ANY_PAGE
    {
        ...
        public function hap_section_one_text()
        {
            ...
            echo '<p class="hide-any-page-para instructions">' . __('Note: Tick the checkbox for the page that you want to hide, and then click the Save button to apply your changes.', 'hide-any-page') . '</p>';
        }
